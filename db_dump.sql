...
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_nopad_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `django_migrations` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_nopad_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `main_accounttype` (
  ...
  `created_at` datetime(6) NOT NULL,
  `balance_type` varchar(1) COLLATE utf8mb4_unicode_520_nopad_ci NOT NULL,
  `is_archived` tinyint(1) NOT NULL,
  `is_default` tinyint(1) NOT NULL,
  `level_type` varchar(1) COLLATE utf8mb4_unicode_520_nopad_ci NOT NULL,
...
CREATE TABLE `main_currency` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE utf8mb4_unicode_520_nopad_ci NOT NULL,
  `symbol` varchar(3) COLLATE utf8mb4_unicode_520_nopad_ci NOT NULL,
  `code` varchar(3) COLLATE utf8mb4_unicode_520_nopad_ci NOT NULL,
